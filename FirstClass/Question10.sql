...
-- perform joins to get output bandcharacter varying
--event_datecharacter varying
--species_namecharacter varying
--age_descriptioncharacter varying
--sex_descriptioncharacter varying


-- event table
SELECT * FROM sex AS s
SELECT * FROM age 

SELECT b.original_band, b.event_date, b.species_name, a.age_description, s.sex_description
FROM bird_bands as b 
INNER JOIN  sex as s
ON b.sex_code = s.sex_code
INNER JOIN age as a
